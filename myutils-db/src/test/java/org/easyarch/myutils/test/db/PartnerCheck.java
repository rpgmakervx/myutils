 ...
 * 上午10:34
 * description: 订单和外部供应商对账结果
 */
@Table(tableName = "check_result_order_parternerorder")
public class PartnerCheck {
     ...
     * 外部合作方订单状态
     */
    @Column(name = "status_parterner_order")
    private int statusParternerOrder;

    /**
     * 外部合作方订单金额
     */
    @Column(name = "money_parterner_order")
    private BigDecimal moneyParternerOrder;
    ...
    public int getStatusParternerOrder() {
        return statusParternerOrder;
    }

    public void setStatusParternerOrder(int statusParternerOrder) {
        this.statusParternerOrder = statusParternerOrder;
    }

    public BigDecimal getMoneyParternerOrder() {
        return moneyParternerOrder;
    }

    public void setMoneyParternerOrder(BigDecimal moneyParternerOrder) {
        this.moneyParternerOrder = moneyParternerOrder;
    }
    ...
    public String toString() {
        return "PartnerCheck{" +
                ...
                ", statusParternerOrder=" + statusParternerOrder +
                ", moneyParternerOrder=" + moneyParternerOrder +
