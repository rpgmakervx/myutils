...
public class ArrayUtils {
    ...
    public static <T> void foreach(T[] array, LoopHandler<T> loop) {
    ...
    public static void foreach(int[] array, LoopHandler<Integer> loop) {
        if (isEmpty(array) || loop == null)
            return;
        int index = 0;
        for (Integer t : array) {
    ...
    public static void foreach(float[] array, LoopHandler<Float> loop) {
        if (isEmpty(array) || loop == null)
            return;
        int index = 0;
        for (Float t : array) {
    ...
    public static void foreach(double[] array, LoopHandler<Double> loop) {
        if (isEmpty(array) || loop == null)
            return;
        int index = 0;
        for (Double t : array) {
    ...
    public static void foreach(long[] array, LoopHandler<Long> loop) {
        if (isEmpty(array) || loop == null)
            return;
        int index = 0;
        for (Long t : array) {
    ...
    public static void foreach(byte[] array, LoopHandler<Byte> loop) {
        if (isEmpty(array) || loop == null)
            return;
        int index = 0;
        for (Byte t : array) {
    ...
    public static void foreach(short[] array, LoopHandler<Short> loop) {
        if (isEmpty(array) || loop == null)
            return;
        int index = 0;
        for (Short t : array) {
